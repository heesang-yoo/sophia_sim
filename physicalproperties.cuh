...
extern Real k_Tab_T[table_size];
extern Real k_Tab_h[table_size];
extern Real k_Tab_k[table_size];
extern Real k_Tab_cp[table_size];
extern Real k_Tab_vis[table_size];

extern int k_table_index[10];
extern int k_table_size[10];
